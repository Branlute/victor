...
namespace VictorNamespace
{
    public class Image_Texture
    {
        ...
        public Image_Texture(int idQuestion, string name, List<string> assetName, List<Vector2> position, List<int> longueur, List<int> hauteur)
        {
        ...
        public Image_Texture(int idQuestion, string name, string assetName, Vector2 position, int longueur, int hauteur)
        {
            _idQuestion = idQuestion;
            _name = name;
            _assetName = new List<string>();
